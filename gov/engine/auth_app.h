...
namespace auth { //engine network support, this service is free
...
//	typedef chrono::steady_clock::time_point time_point;
	...
	struct app: engine::runnable_app {
        ...
        virtual evidence* parse_evidence(uint16_t service, const string& datagram_payload) const override { return 0;}
