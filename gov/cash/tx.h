...
//			cash_t prev_balance;
		...
		void add_input(const hash_t& addr/*, const cash_t& prev_balance*/, const cash_t& amount);
		void add_input(const hash_t& addr/*, const cash_t& prev_balance*/, const cash_t& amount, const string& locking_program_input);
		void add_output(const hash_t& addr, const cash_t& amount, const hash_t& locking_program);
