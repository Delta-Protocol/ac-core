...
void print_cpp_wallet_daemon_delegate_api(const string&file, const string& t, ostream& os) {
    ifstream is(file);
    api_t api=api_t::from_stream(is);
    api.gen_cpp_wallet_daemon_delegate(t,os);
}
...
void print_wallet_daemon_purevir_api(ostream&os) {
    os << "// wallet" << endl;
    print_cpp_purevir_api("data/wallet/cpp", [](ostream& os) {
        }, [](ostream& os) {
        }, [](ostream& os) {
...
cout << "writting file apitool_generated_pairing.h" << endl;
    ofstream os("apitool_generated_pairing.h");
    os << "//------------------file generated by apitool- do not edit" << endl;
...
void gen_wallet_daemon_header() {
cout << "writting file apitool_generated_wallet_daemon.h" << endl;
    ofstream os("apitool_generated_wallet_daemon.h");
    os << "//------------------file generated by apitool- do not edit" << endl;
    os << "#ifndef USGOV_56573006533bd7c4eca53cd618dca5cfa853c9685c38769d3f79e89cdc9175e9" << endl;
    os << "#define USGOV_56573006533bd7c4eca53cd618dca5cfa853c9685c38769d3f79e89cdc9175e9" << endl;
    os << endl;
    os << "#include \"apitool_generated_pairing.h\"" << endl;
    os << "#include \"apitool_generated_wallet.h\"" << endl;
    os << endl;
    os << "namespace us{ namespace api {" << endl;
    os << "using namespace std;" << endl;
    os << endl;
    os << "struct wallet_daemon: wallet, pairing  {" << endl;
    os << "  virtual ~wallet_daemon() {}" << endl;
    os << "  using wallet::priv_t;" << endl;
    os << "  using wallet::pub_t;" << endl;
    
    os << endl;
    print_wallet_daemon_purevir_api(os);
    os << "};" << endl;
    os << "}}" << endl;
    os << "#endif" << endl;
}
...
void gen_functions_wallet_daemon_cpp_impl() {
    {
    cout << "writting file apitool_generated_wallet_daemon_functions_cpp_impl" << endl;
    ofstream os("apitool_generated_wallet_daemon_functions_cpp_impl");
    print_wallet_daemon_delegate_api(os);
    }
}
