...
struct api {
	...
	virtual void nova_load(const nova::hash_t& item, const nova::hash_t& compartiment, bool action, ostream&)=0;
	virtual void nova_reading(const nova_reading_input&, ostream&)=0;
};
...
struct rpc_api:api {
	...
	virtual void nova_load(const nova::hash_t& item, const nova::hash_t& compartiment, bool action, ostream&) override;
...
struct local_api:api, wallet, pairing {
	...
	virtual void nova_load(const nova::hash_t& item, const nova::hash_t& compartiment, bool action, ostream&) override;
	virtual void nova_reading(const api::nova_reading_input&, ostream&) override;
