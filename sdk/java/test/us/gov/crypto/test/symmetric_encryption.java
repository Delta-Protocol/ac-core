...
public class symmetric_encryption {
    ...
    public boolean testSymmetricEncryption() throws Exception{
        ...
        try{
            a = us.gov.crypto.ec.instance.generateKeyPair();
            b = us.gov.crypto.ec.instance.generateKeyPair();
            c = us.gov.crypto.ec.instance.generateKeyPair();
    ...
    public boolean test_encrypt_decrypt_keys(String plaintext_string, PrivateKey priv_a, PublicKey pub_b, PrivateKey priv_b, PublicKey pub_a) throws GeneralSecurityException{
        ...
        us.gov.crypto.symmetric_encryption se_a= new us.gov.crypto.symmetric_encryption(priv_a,pub_b);
        byte[] ciphertext = se_a.encrypt(plaintext);
       
        us.gov.crypto.symmetric_encryption se_b= new us.gov.crypto.symmetric_encryption(priv_b,pub_a);
    ...
    public boolean test_decrypt_nulls(String ciphertext_string) throws GeneralSecurityException{
        ...
        us.gov.crypto.symmetric_encryption se = new us.gov.crypto.symmetric_encryption(priv_a,pub_b);
